...
namespace TreeDiagram.Migrations
{
    ...
    [Migration("20200716153023_DatabaseRevamp")]
    partial class DatabaseRevamp
    {
            ...
            modelBuilder.Entity("TreeDiagram.Models.Filter.FilterCaps", b =>
                {
                    ...
                    b.Property<List<ulong>>("IgnoredChannels")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("TreeDiagram.Models.Server.ServerInactivity", b =>
                {
                    ...
                    b.Property<List<ulong>>("RoleWhitelist")
                        .HasColumnType("jsonb");

                    b.Property<List<ulong>>("UserWhitelist")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("TreeDiagram.Models.Server.ServerMusic", b =>
                {
                    ...
                    b.Property<List<ulong>>("AllowedRoles")
                        .HasColumnType("jsonb");
