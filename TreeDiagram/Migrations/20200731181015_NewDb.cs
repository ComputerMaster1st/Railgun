...
namespace TreeDiagram.Migrations
{
    public partial class NewDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "MusicAutoJoinConfig",
                columns: table => new
                {
                    VoiceChannelId = table.Column<decimal>(nullable: false),
                    TextChannelId = table.Column<decimal>(nullable: false),
                    ServerMusicId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicAutoJoinConfig", x => x.VoiceChannelId);
                    table.ForeignKey(
                        name: "FK_MusicAutoJoinConfig_ServerMusic_ServerMusicId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MusicAutoJoinConfig_ServerMusicId",
