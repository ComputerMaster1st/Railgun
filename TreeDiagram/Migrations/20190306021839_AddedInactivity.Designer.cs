...
namespace TreeDiagram.Migrations
{
    ...
    [Migration("20190306021839_AddedInactivity")]
    partial class AddedInactivity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TreeDiagram.Models.Server.Inactivity.ServerInactivity", b =>
                {
                    b.Property<decimal>("Id")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
            ...
            modelBuilder.Entity("TreeDiagram.Models.Server.Inactivity.UserActivityContainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TreeDiagram.Models.Server.UlongRoleId", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TreeDiagram.Models.Server.UlongUserId", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TreeDiagram.Models.Server.Inactivity.UserActivityContainer", b =>
                {
                    b.HasOne("TreeDiagram.Models.Server.Inactivity.ServerInactivity")
                        .WithMany("Users")
